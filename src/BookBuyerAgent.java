    ...
    private class RequestPerformer extends Behaviour {
      ...
      public void action() {
        ...
        case 1:
          ...
          if(current >= 3000) {
				System.out.println("Reaching case 2, timeout is : " + current);
				System.out.println("Timeout must have been reached and no reply was found. Continuing order.");
				step = 2;
				break;
			}
          ...
          if (reply != null) {
            ...
            if (repliesCnt >= sellerAgents.length) {
			  ...
			  System.out.println("blocked at case 1.");
        ...
        case 2:
         ...
         if(budget < bestPrice ){
            System.out.println(getAID().getLocalName() + ": Not enough budget.");
            step =4;
            break;
         }
        ...
        case 3:      
          ...
          if (reply != null) {
            if (reply.getPerformative() == ACLMessage.INFORM) {
              ...
              System.out.println(getAID().getLocalName() + ": remaining budget is : "+ budget);
